...
char* (*BUILTINSFONC[NBBUILTINFONC])(strlist*, intlist*, int*)={_print_,_input_,_nbr_,_str_,_len_,_substring_,_exit_,_append_,_remove_,_insert_,_type_, _reverse_, _eval_};
...
int main (int argc, char* argv[])
{
    ...
    NOMSBUILTINSFONC=(strlist){(char*[NBBUILTINFONC]){"print","input","nbr","str","len","sub","exit","append","remove","insert","type", "reverse", "eval"},NBBUILTINFONC};
