...
char* _help_(strlist* args, intlist* types, int* typeRetour)
{
    ...
    //faire en sorte que help(nom de la fonction) renvoie une aide correspondant à la fonction, i.e. faire une strlist qui contient l'aide liée à chaque nom de fonction stockée dans BUILTINFONC
    
    printf("Aucune aide n'est disponible pour le moment.\n");
...
char* _clear_(strlist* args, intlist* types, int* typeRetour){
  //printf("\r\b\r\b\r\b\r\b\r\b\r\b");
  printf("\e[1;1H\e[2J");
