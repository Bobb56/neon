...
#define NB_ERRORS 110

#define STACK_SIZE (1 << 23) // taille de la pile par défaut à 8 Mio, ça peut changer en fonction de la plateforme
...
Number number_incr(Number n, int incr);
...
/*OPFONC.C*/
NeObject* _and(Tree* tree1, Tree* tree2);
NeObject* _or(Tree* tree1, Tree* tree2);
...
NeObject* _incr(NeObject* op1);
NeObject* _decr(NeObject* op1);
void _setNumber(NeObject* op1, Number n);
NeObject* _not(NeObject* op1);
NeObject* _mod(NeObject* op1, NeObject* op2);
NeObject* _eucl(NeObject* op1, NeObject* op2);
NeObject* _ref(NeObject* op1);
NeObject* _goIn(NeObject* op1, NeObject* op2);
NeObject* _minus(NeObject* op1);
NeObject* _del(NeObject* op1);
