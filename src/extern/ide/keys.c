 ...
 */
short kmain[] = {
    KEY_NO_EXIST, KEY_DOWN, KEY_LEFT, KEY_RIGHT, KEY_UP,
 ...
 */
short ksec[] = {
    KEY_NO_EXIST, KEY_WDOWN, KEY_WLEFT, KEY_WRIGHT, KEY_WUP,
 ...
 */
short kshift[] = {
    KEY_NO_EXIST, KEY_SDOWN, KEY_SLEFT, KEY_SRIGHT, KEY_SUP,
    KEY_NO_EXIST, KEY_NO_EXIST, KEY_NO_EXIST, KEY_NO_EXIST, '\n', '\'', 'W',
 ...
 */
short kmeta[] = {
    KEY_NO_EXIST, KEY_LDOWN, KEY_LLEFT, KEY_LRIGHT, KEY_LUP,
    KEY_NO_EXIST, KEY_NO_EXIST, KEY_NO_EXIST, KEY_NO_EXIST, KEY_UNBOUND,
 ...
 */
short ksecshift[] = {
    KEY_NO_EXIST, KEY_WSDOWN, KEY_WSLEFT, KEY_WSRIGHT,
 ...
 */
short kmetashift[] = {
    KEY_NO_EXIST, KEY_LSDOWN, KEY_LSLEFT, KEY_LSRIGHT,
        ...
        if(state->blinkcursor)
            if(frame>400) {
                ...
                if(on) {
                    ...
                    gfx_VertLine_NoClip(cx, cy, LINE_SPACING);
                    on=false;
                } else {
                    gfx_SetColor(state->text_color);
                    gfx_VertLine_NoClip(cx, cy, LINE_SPACING);
