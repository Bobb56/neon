...
NeObj _affect(NeObj op1, NeObjAddr* op2);
NeObj _affectNone(NeObjAddr* op1, NeObj op2);
void _affect2(NeObjAddr* op1, NeObj op2);
...
NeObj _incr(NeObjAddr* op1);
void _incr2(NeObjAddr* op1, int incr);
NeObj _decr(NeObjAddr* op1);
