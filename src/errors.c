...
static const char* error_messages[NB_ERRORS] = {
    ...
    "Arguments cannot be named while calling <> as a function using call overloading.",
    "Attempt to call an object of type <>.",
    ...
    "When <> is set, its value overloads the <> operation on containers of type <>. Therefore <> must always be a user function",
    "The <> function must take at least <> mandatory arguments.",
    "Bad right operand for operator is.\nThe right operand can only be a literal Const or a variable.",
    "<> arguments should be variable names, but an expression of type <> was given.",
    ...
    "This object cannot be deserialized because it was serialized on a different platform: <>.",
    "Cannot reverse <>.",
