...
typedef struct Process
{
    ...
    uint8_t state;
    TreeBuffer* original_call_buffer;
...
Process* ProcessCycle_add(ProcessCycle* pc, TreeBuffer* tb, TreeBufferIndex tree, NeObj fixed_function, int id, bool isInitialized, InterpContext* interp_context);
...
int create_new_process(TreeBuffer* tb, TreeBufferIndex tree, NeObj fixed_function, bool isInitialized, InterpContext* interp_context);
