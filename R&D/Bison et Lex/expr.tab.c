...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULTIPLY", "DIVIDE", "LPAREN", "RPAREN", "$accept", "input",
...
yyreduce:
  ...
  case 2: /* input: expr  */
#line 55 "expr.y"
         { printAST((yyvsp[0].node), 0); freeAST((yyvsp[0].node)); }
...
#line 71 "expr.y"
                     { (yyval.node) = createNode('n', (yyvsp[0].number), NULL, NULL); }
