...
_Bool neobject_destroy(NeObject* neo,_Bool bo);
...
int neobject_autoref(NeObject* neo, _Bool* idref);
_Bool neobject_destroy_aux(NeObject* neo, _Bool bo, NeObject* baseObj, _Bool externCall);
void nelist_destroy_aux(NeList* list,_Bool bo, NeObject* baseObj);
//void update_count(NeObject* neo, unigned* refc);
