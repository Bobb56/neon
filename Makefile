...
C_src = src/neon.c src/operators.c src/builtinfunctions.c src/strings.c src/dynarrays.c src/parser.c src/syntaxtrees.c src/neonio.c src/objects.c src/printerror.c src/linenoise.c src/gc.c src/runtime.c src/processcycle.c src/main.c
