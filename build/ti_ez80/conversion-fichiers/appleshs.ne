...
screen = Screen(
    ...
    score: Text(text: "Score: 0", x:5, y:5, fgcolor: 0, bgcolor:255, size:1),
    hscore: Text(text: "High score: 0", x:5, y:25, fgcolor: 0, bgcolor:255, size:1)
)
...
function load_highscore() do
    try
        highscore = int(readFile("applsDAT"))
    except () do
        highscore = 0
    end
end
